...
<h1 className='text-3xl md:text-3xl lg:text-4xl font-bold mt-1'><span className='text-[#0a6335] font-bold'>Mueza</span> Ejaz</h1>
...
<p className='mt-1 md:mt-3 w-[100%] text-sm'>I’m a Frontend Developer skilled in building responsive, user-friendly web applications. Proficient in HTML, CSS,Tailwindcss,Figma, Jawascript/Typescript, React, and Next.js, I focus on writing clean code and creating seamless, intuitive interfaces.</p>
