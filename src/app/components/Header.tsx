...
const Header = () => {
 ...
 <Image src={Logo} width={200} height={200} alt="logo" className="md:w-[100px]"/>
  </div> 
 ...
 {/* NavBar For SMall Devices */}
  ...
  <nav className="md:hidden">{!isActive ?  <MdCancel size={50} className="absolute top-0 right-0 z-30 mt-4 mr-4"  onClick={()=>{
    ...
    <ul className={`${isActive ? 'hidden':'flex'} flex-col  justify-center items-center  text-white text-[1.5rem] bg-[#0a6335] bg-opacity-80 absolute top-0 w-full py-4 rounded-b-3xl z-10`}>
